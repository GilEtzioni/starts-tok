...
const SuccessMessage: React.FC<SuccessMessageProps> = ({ onClick }) => {
    ...
    return (
        <Card
            style={{ top: `${topCss(order)}px` }}
            onClick={handleClick}
            bordered={false}
            className="bg-green-100 text-white text-center flex items-center justify-center w-72 h-24 mx-auto rounded-lg relative shadow-md"
        >
