...
const LevelButton: React.FC<LevelButtonProps> = ({ buttNameHebrew, buttNameEnglish }) => {
  ...
  return (
    <Card
      onClick={handleClick}
     className={classNames("duration-300 ease-in-out hover:-translate-y-0.5 bg-green-500 text-white border border-green-600 border-b-4 border-0 h-8 text-center flex justify-center items-center h-12 transition-all duration-200 ease-linear", {
